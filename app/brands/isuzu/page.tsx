...
const getIsuzuVehicles = unstable_cache(
  () =>
...
export default async function IsuzuPage() {
  const vehicles = await getIsuzuVehicles()
  ...
  const itemListSchema = {
    '@context': 'https://schema.org',
    '@type': 'ItemList',
    '@id': 'https://www.a-ztrucksales.com/brands/isuzu#inventory',
    name: 'Used Isuzu Trucks in Stock',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="text-lg text-gray-600 space-y-4">
                <p>
                  Isuzu is one of South Africa&rsquo;s most trusted commercial vehicle
