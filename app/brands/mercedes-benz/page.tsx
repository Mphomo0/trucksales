...
const getMercedesVehicles = unstable_cache(
  () =>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="text-lg text-gray-600 space-y-4">
                <p>
                  Mercedes-Benz is one of the world&rsquo;s most recognised commercial
