...
export const metadata: Metadata = {
  ...
  description:
    'Practical guides to buying used rigid trucks in Gauteng. Learn about truck body types, choosing the right brand, inspection tips and more from A-Z Truck Sales.',
  alternates: { canonical: 'https://www.a-ztrucksales.com/guides' },
  openGraph: {
    title: 'Used Truck Buying Guides | A-Z Truck Sales',
    description:
      'Guides to buying used rigid trucks in Gauteng. Body types, brands, inspection tips and buying advice.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Used Truck Buying Guides - A-Z Truck Sales',
      },
    ],
    locale: 'en_ZA',
    type: 'website',
